...
public class CatalogReadController {
    ...
    private final CatalogAnalogsService analogs;private final TrustedScopeResolver admin;
    public CatalogReadController(CatalogDataAdapter adapter,CatalogRepository repository,CatalogOfferService offers,CatalogAnalogsService analogs,TrustedScopeResolver admin){this.adapter=adapter;this.repository=repository;this.offers=offers;this.analogs=analogs;this.admin=admin;}
