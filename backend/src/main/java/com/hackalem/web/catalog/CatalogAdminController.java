...
import com.hackalem.security.TrustedScope;
 ...
 *
 * Проверка прав временно опирается на общий токен (см. TrustedScopeResolver);
 * после AUTH-01 она станет проверкой роли у серверной identity.
 */
@RestController
...
public class CatalogAdminController {
    ...
    public ResponseEntity<CatalogResponses.ImportJobResponse> startImport(
        ...
        TrustedScope scope = scopeResolver.requireAdmin(httpRequest);
